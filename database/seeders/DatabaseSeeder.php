...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::statement('SET FOREING_KEY_CHECKS = 0');//como se hacen eliminaciones desordenadas de las claves foraneas, con este comando se evitan inconsistencias
        ...
        Product::factory($cantidadProductos)->create()->each(//para cada instancia creada ejecute lo siguiente
            function($producto){//funcion anonima, recibe cada uno de los productos uno a uno y adicionalmente le enviamos las categorias 
                ...
                $producto->categories()->attach($categorias);//optenemos la lista completa de categorias
